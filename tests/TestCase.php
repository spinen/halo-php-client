...
abstract class TestCase extends PHPUnitTestCase
{
    ...
    {
        $this->configs = (array) require __DIR__.'/../config/halo.php';
        $this->configs['oauth']['authorization_server'] = 'http://authorizationserver.local/auth';
        $this->configs['resource_server'] = 'http://resourceserver.local/api';
    }
